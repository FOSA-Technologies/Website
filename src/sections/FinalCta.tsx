...
export default function FinalCta() {
  return (
    <section id="contact" className="relative overflow-hidden bg-fosa-500 py-20 lg:py-28" aria-labelledby="cta-title">
      ...
      />
      <div
        className="absolute -bottom-28 -left-24 size-[320px] rotate-45 bg-navy-900/[0.06]"
        aria-hidden="true"
      />
      <div className="absolute left-[10%] top-14 size-9 rotate-45 bg-navy-900/[0.08]" aria-hidden="true" />
      <div className="absolute right-[14%] bottom-16 size-6 rotate-45 bg-navy-900/[0.08]" aria-hidden="true" />
      <div
        className="absolute -left-[8%] top-20 h-px w-[120%] -rotate-[10deg] bg-navy-900/[0.12]"
        aria-hidden="true"
      />
      <div
        className="absolute left-[6%] bottom-24 h-px w-[90%] rotate-[7deg] bg-navy-900/[0.08]"
        aria-hidden="true"
      />
